...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_customSelect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/customSelect */ \"./app/js/modules/customSelect.js\");\n/* harmony import */ var _modules_mobileMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/mobileMenu */ \"./app/js/modules/mobileMenu.js\");\n/* harmony import */ var _modules_setServices__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/setServices */ \"./app/js/modules/setServices.js\");\n/* harmony import */ var _modules_currencyExchange__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/currencyExchange */ \"./app/js/modules/currencyExchange.js\");\n/* harmony import */ var _modules_changeHeaderByScroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/changeHeaderByScroll */ \"./app/js/modules/changeHeaderByScroll.js\");\n/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modal */ \"./app/js/modules/modal.js\");\n/* harmony import */ var _modules_outputConsoleName__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/outputConsoleName */ \"./app/js/modules/outputConsoleName.js\");\n\n\n\n\n\n\n\nwindow.addEventListener('DOMContentLoaded', function () {\n  Object(_modules_changeHeaderByScroll__WEBPACK_IMPORTED_MODULE_4__[\"changeHeaderByScroll\"])('.header');\n  Object(_modules_customSelect__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('#level-select');\n  Object(_modules_mobileMenu__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('.control-btn', '.widget');\n  Object(_modules_currencyExchange__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  Object(_modules_setServices__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_5__[\"modal\"])('modal');\n  Object(_modules_outputConsoleName__WEBPACK_IMPORTED_MODULE_6__[\"default\"])('%c D %c E %c N %c N %c I %c S ');\n});\n\n//# sourceURL=webpack:///./app/js/main.js?");
...
/***/ "./app/js/modules/currencyExchange.js":
/*!********************************************!*\
  !*** ./app/js/modules/currencyExchange.js ***!
  \********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _setServices__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./setServices */ \"./app/js/modules/setServices.js\");\n\n\nfunction exchangeCurrency() {\n  var currencyItems = document.querySelectorAll('.form-currency__item');\n  var baseValues = [];\n  var valuesFields = document.querySelectorAll('input[name=\"value\"]');\n  valuesFields.forEach(function (field) {\n    baseValues.push(field.value);\n  });\n\n  function setValues(rate) {\n    var currencyCounts = document.querySelectorAll('.value-count');\n\n    for (var i = 0, j = 0; baseValues.length, j < valuesFields.length; i++, j++) {\n      valuesFields[j].value = \"\".concat(Math.floor(baseValues[i] * rate * 100) / 100);\n    }\n\n    currencyCounts.forEach(function (count) {\n      var countSelector = count.parentElement.querySelector('.value-count');\n      var countValue = count.parentElement.querySelector('input[name=\"value\"]').value;\n      countSelector.textContent = \"\".concat(countValue);\n    });\n  }\n\n  function setCurrencyMark(symbol) {\n    var currentMarks = document.querySelectorAll('.value-mark');\n    var totalMark = document.querySelector('.form-total__mark');\n    var modalTotalMark = document.querySelector('.modal-desc__currency');\n    currentMarks.forEach(function (mark) {\n      mark.textContent = symbol;\n    });\n    totalMark.textContent = symbol;\n    modalTotalMark.textContent = symbol;\n  }\n\n  function clearTotal() {\n    var totalPayContainer = document.querySelector('.form-total__pay');\n    var totalField = document.querySelector('.form-total__field');\n    totalPayContainer.textContent = '0';\n    totalField.value = 0;\n  }\n\n  for (var i = 0; i < currencyItems.length; i++) {\n    currencyItems[i].addEventListener(\"click\", function () {\n      var current = document.getElementsByClassName('currency--active');\n      current[0].className = current[0].className.replace('currency--active', '');\n      this.className += ' currency--active';\n      var currentCurrency = this.getAttribute('data-currency');\n\n      switch (currentCurrency) {\n        case 'usd':\n          setCurrencyMark('$');\n          setValues(1);\n          break;\n\n        case 'eur':\n          setCurrencyMark('€');\n          setValues(.83);\n          Object(_setServices__WEBPACK_IMPORTED_MODULE_0__[\"clearSelectedFields\"])();\n          clearTotal();\n          break;\n\n        case 'cad':\n          setCurrencyMark('C$');\n          setValues(1.25);\n          Object(_setServices__WEBPACK_IMPORTED_MODULE_0__[\"clearSelectedFields\"])();\n          clearTotal();\n          break;\n\n        case 'gbr':\n          setCurrencyMark('£');\n          setValues(0.73);\n          Object(_setServices__WEBPACK_IMPORTED_MODULE_0__[\"clearSelectedFields\"])();\n          clearTotal();\n          break;\n\n        case 'aud':\n          setCurrencyMark('A$');\n          setValues(1.29);\n          Object(_setServices__WEBPACK_IMPORTED_MODULE_0__[\"clearSelectedFields\"])();\n          clearTotal();\n          break;\n      }\n    });\n  }\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (exchangeCurrency);\n\n//# sourceURL=webpack:///./app/js/modules/currencyExchange.js?");
