...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_customSelect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/customSelect */ \"./app/js/modules/customSelect.js\");\n/* harmony import */ var _modules_mobileMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/mobileMenu */ \"./app/js/modules/mobileMenu.js\");\n/* harmony import */ var _modules_setServices__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/setServices */ \"./app/js/modules/setServices.js\");\n/* harmony import */ var _modules_changeHeaderByScroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/changeHeaderByScroll */ \"./app/js/modules/changeHeaderByScroll.js\");\n/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modal */ \"./app/js/modules/modal.js\");\n/* harmony import */ var _modules_outputConsoleName__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/outputConsoleName */ \"./app/js/modules/outputConsoleName.js\");\n\n\n\n\n\n\nwindow.addEventListener('DOMContentLoaded', function () {\n  Object(_modules_changeHeaderByScroll__WEBPACK_IMPORTED_MODULE_3__[\"changeHeaderByScroll\"])('.header');\n  Object(_modules_customSelect__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('#level-select');\n  Object(_modules_setServices__WEBPACK_IMPORTED_MODULE_2__[\"initTableHandler\"])('.row');\n  Object(_modules_setServices__WEBPACK_IMPORTED_MODULE_2__[\"initChangeCurrency\"])('.form-currency__item');\n  Object(_modules_mobileMenu__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('.control-btn', '.widget');\n  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_4__[\"modal\"])('modal');\n  Object(_modules_outputConsoleName__WEBPACK_IMPORTED_MODULE_5__[\"default\"])('%c D %c E %c N %c N %c I %c S ');\n});\n\n//# sourceURL=webpack:///./app/js/main.js?");

/***/ }),

/***/ "./app/js/modules/changeHeaderByScroll.js":
/*!************************************************!*\
  !*** ./app/js/modules/changeHeaderByScroll.js ***!
  \************************************************/
/*! exports provided: changeHeaderByScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"changeHeaderByScroll\", function() { return changeHeaderByScroll; });\nfunction changeHeaderByScroll(headerSelector) {\n  var scrollPos = window.scrollY;\n  var header = document.querySelector(headerSelector);\n  var headerHeight = header.offsetHeight;\n\n  var addClassOnScroll = function addClassOnScroll() {\n    return header.classList.add('header-scroll');\n  };\n\n  var removeClassOnScroll = function removeClassOnScroll() {\n    return header.classList.remove('header-scroll');\n  };\n\n  window.addEventListener('scroll', function () {\n    scrollPos = window.scrollY;\n\n    if (scrollPos >= headerHeight) {\n      addClassOnScroll();\n    } else {\n      removeClassOnScroll();\n    }\n  });\n}\n\n//# sourceURL=webpack:///./app/js/modules/changeHeaderByScroll.js?");

/***/ }),

/***/ "./app/js/modules/customSelect.js":
/*!****************************************!*\
  !*** ./app/js/modules/customSelect.js ***!
  \****************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction outputConsoleName(name) {\n  var colors = ['background: #4557FC', 'background: #2F43FC', 'background: #182FFB', 'background: #041CF9', 'background: #031AE2', 'background: #0317CB'];\n  console.log(name, colors[0], colors[1], colors[2], colors[3], colors[4], colors[5]);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (outputConsoleName);\n\n//# sourceURL=webpack:///./app/js/modules/outputConsoleName.js?");

/***/ }),

/***/ "./app/js/modules/setServices.js":
/*!***************************************!*\
  !*** ./app/js/modules/setServices.js ***!
  \***************************************/
/*! exports provided: services, initTableHandler, initChangeCurrency */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"services\", function() { return services; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"initTableHandler\", function() { return initTableHandler; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"initChangeCurrency\", function() { return initChangeCurrency; });\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && Symbol.iterator in Object(iter)) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n// Getting initial field values ​​from HTML\nvar getBaseValues = function getBaseValues() {\n  var values = [];\n  var valuesFields = document.querySelectorAll('.value-input');\n  valuesFields.forEach(function (field) {\n    values.push(field.value);\n  });\n  return values;\n};\n\nvar services = {\n  // Set total field value\n  total: 0.00,\n  // Set default rate\n  rate: 1,\n  // Check changes and update total value. At the entrance takes inputSelector of total field and total selector in HTML\n  setTotalValue: function setTotalValue(totalFieldSelector, totalValueSelector) {\n    var _this = this;\n\n    var totalField = document.getElementById(totalFieldSelector);\n    var totalSelector = document.querySelector(totalValueSelector);\n    totalField.value = +this.total;\n    totalSelector.textContent = \"\".concat((totalField.value * this.rate).toFixed(2));\n    totalField.addEventListener('change', function () {\n      totalSelector.textContent = \"\".concat((totalField.value * _this.rate).toFixed(2));\n    });\n    return Number(totalField.value);\n  },\n  // Set rate when currency changes\n  setRate: function setRate(rate) {\n    this.rate = +rate;\n    return this.rate;\n  },\n  // Up the total value after choosing a service\n  upTotal: function upTotal(value) {\n    this.total = this.total + +value;\n  },\n  // Down the total value after choosing a service\n  downTotal: function downTotal(value) {\n    this.total = this.total - +value;\n  },\n  // Set values after currency changes\n  setInputValues: function setInputValues() {\n    var valueCount = document.querySelectorAll('.value-count');\n\n    for (var i = 0, v = 0; i < getBaseValues().length, v < valueCount.length; i++, v++) {\n      valueCount[v].textContent = \"\".concat(Math.floor(getBaseValues()[i] * this.rate * 100) / 100);\n    }\n\n    this.setTotalValue('total', '.form-total__pay');\n  },\n  // Set current currency mark\n  setCurrencyMark: function setCurrencyMark(symbol) {\n    var currentMarks = document.querySelectorAll('.value-mark');\n    var totalMark = document.querySelector('.form-total__mark');\n    var modalTotalMark = document.querySelector('.modal-desc__currency');\n    currentMarks.forEach(function (item) {\n      item.textContent = symbol;\n    });\n    totalMark.textContent = symbol;\n    modalTotalMark.textContent = symbol;\n  },\n  // Adds an activity class and activates the input value to the selected value\n  toggleValue: function toggleValue(elem, activeSelector, inputSelector) {\n    var input = elem.querySelector(inputSelector);\n\n    if (elem.classList.contains(activeSelector)) {\n      elem.classList.remove(activeSelector);\n      input.checked = false;\n    } else {\n      elem.classList.add(activeSelector);\n      input.checked = true;\n    } // This function expression removes unselected values from the row\n\n\n    var siblings = function siblings(elem) {\n      var nodes = _toConsumableArray(elem.parentNode.children);\n\n      return nodes.filter(function (node) {\n        return node !== elem;\n      });\n    };\n\n    siblings(elem).forEach(function (node) {\n      node.classList.remove(activeSelector);\n      var input = node.querySelector(inputSelector);\n\n      if (input) {\n        input.checked = false;\n      }\n    });\n  },\n  // Selection of the active value from the row\n  checkValue: function checkValue(row) {\n    var rowValues = row.querySelectorAll('.value'); // Get the input value of the previous click\n\n    function getPrevValue() {\n      var prev = 0;\n      var inputField = row.querySelectorAll('.value-input');\n      inputField.forEach(function (field) {\n        if (field.checked) {\n          prev = +field.value;\n        }\n      });\n      return prev;\n    } // Get the input value of the current click\n\n\n    function handler(rowValue) {\n      var prevValue = getPrevValue();\n      var input = rowValue.querySelector('.value-input');\n      services.toggleValue(rowValue, 'value--active', '.value-input');\n\n      if (rowValue.classList.contains('value--active')) {\n        services.upTotal(input.value);\n        services.downTotal(prevValue);\n      } else {\n        services.downTotal(input.value);\n      }\n\n      services.setTotalValue('total', '.form-total__pay');\n    }\n\n    rowValues.forEach(function (rowValue) {\n      rowValue.addEventListener('click', function () {\n        return handler(rowValue);\n      });\n    });\n  },\n  // Initializing a click handler for a table\n  initCheckValues: function initCheckValues(rowSelector) {\n    var _this2 = this;\n\n    var rows = document.querySelectorAll(rowSelector);\n    rows.forEach(function (row) {\n      return _this2.checkValue(row);\n    });\n  },\n  // Change currency function\n  changeCurrency: function changeCurrency(changeCurrencyButtonsSelector) {\n    var currencyButtons = document.querySelectorAll(changeCurrencyButtonsSelector);\n\n    var _loop = function _loop(i) {\n      currencyButtons[i].addEventListener(\"click\", function () {\n        var current = document.querySelectorAll('.currency--active');\n        current[0].className = current[0].className.replace('currency--active', '');\n        current[0].querySelector('input').checked = false;\n        currencyButtons[i].className += ' currency--active';\n        currencyButtons[i].querySelector('input').checked = true;\n        var currentCurrency = currencyButtons[i].getAttribute('data-currency');\n\n        switch (currentCurrency) {\n          case 'usd':\n            services.setCurrencyMark('$');\n            services.setRate(1);\n            services.setInputValues();\n            break;\n\n          case 'eur':\n            services.setCurrencyMark('€');\n            services.setRate(.83);\n            services.setInputValues();\n            break;\n\n          case 'cad':\n            services.setCurrencyMark('C$');\n            services.setRate(1.25);\n            services.setInputValues();\n            break;\n\n          case 'gbr':\n            services.setCurrencyMark('£');\n            services.setRate(.73);\n            services.setInputValues();\n            break;\n\n          case 'aud':\n            services.setCurrencyMark('A$');\n            services.setRate(1.29);\n            services.setInputValues();\n            break;\n\n          default:\n            services.setCurrencyMark('$');\n            services.setRate(1);\n        }\n      });\n    };\n\n    for (var i = 0; i < currencyButtons.length; i++) {\n      _loop(i);\n    }\n  }\n};\nfunction initTableHandler(rows) {\n  services.initCheckValues(rows);\n}\nfunction initChangeCurrency(changeCurrencyButtonsSelector) {\n  services.changeCurrency(changeCurrencyButtonsSelector);\n}\n\n//# sourceURL=webpack:///./app/js/modules/setServices.js?");
